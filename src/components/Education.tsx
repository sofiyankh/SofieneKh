...
export function Education() {
  ...
  const education = [
    {
      degree: "Licence en Informatique (License in Computer Science)",
      school: "Institut Supérieur d'Informatique de Mahdia (ISIMA)",
      location: "Mahdia, Tunisia",
      period: "2022 - June 2025",
      gpa: "",
      description: "Practical-focused computer science licence with strong emphasis on web development, databases, and software engineering. Completed multiple hands-on projects and internships while improving full-stack and backend skills.",
      coursework: [
      ...
      achievements: [
        "Graduated June 2025",
        "Completed multiple full-stack projects and internships during studies",
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="flex items-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-foreground">{t('education.educationTitle')}</h3>
            </div>
              ...
              {education.map((edu, index) => (
                <SharedBlurCard key={index}>
                  <CardContent className="p-6">
                    ...
                    <div className="mb-4">
                      <h5 className="text-sm font-semibold text-foreground mb-2">{t('education.keyCoursework')}</h5>
                    ...
                    <div>
                      <h5 className="text-sm font-semibold text-foreground mb-2">{t('education.achievements')}</h5>
          ...
          <div>
            <div className="flex items-center mb-8">
              ...
              <h3 className="text-2xl font-bold text-foreground">{t('education.certificationsTitle')}</h3>
            </div>
                ...
                <SharedBlurCard key={index}>
                  <CardContent className="p-6">
                    ...
                    <p className="text-xs text-muted-foreground mb-3">
                      {t('education.credentialId')}: {cert.credentialId}
                    </p>
                    <div>
                      <h5 className="text-sm font-semibold text-foreground mb-2">{t('education.skillsValidated')}</h5>
            ...
            <SharedBlurCard className="mt-6 bg-gradient-to-r from-primary/5 to-accent/5 border-primary/20">
              <CardContent className="p-6 text-center">
                <h4 className="font-bold text-foreground mb-2">{t('education.continuousLearning')}</h4>
                <p className="text-sm text-muted-foreground mb-4">{t('education.continuousDesc')}</p>
                <div className="flex flex-wrap justify-center gap-2">
                  {['Coursera', 'Udemy', 'Pluralsight', 'Tech Conferences'].map((item) => (
                    <Badge key={item} variant="outline" className="text-xs bg-primary/10 border-primary/20 backdrop-blur-sm">
                      {item}
                    </Badge>
                  ))}
                </div>
